...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.bt_get_pic)
        self.label_4 = QtWidgets.QLabel(self.groupBox)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_4)
        self.tv_pic_info = QtWidgets.QTextBrowser(self.groupBox)
        self.tv_pic_info.setObjectName("tv_pic_info")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.tv_pic_info)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "图片信息："))
